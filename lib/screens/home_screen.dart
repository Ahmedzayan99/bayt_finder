    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          if (userStore.latitude.isEmpty && userStore.longitude.isEmpty && userStore.cityName.isEmpty)
            Column(
            ...
            ).visible(userStore.latitude.isEmpty && userStore.longitude.isEmpty && userStore.cityName.isEmpty).center(),
          Container(width: double.infinity, height: double.infinity, color: Colors.transparent, child: Loader().center())
              .visible(appStore.isLoading && (userStore.latitude.isNotEmpty && userStore.longitude.isNotEmpty && userStore.cityName.isNotEmpty))
        ],
      ),
                ...
                children: [
                  data!.propertyCity!.isNotEmpty
                      ? userStore.cityName.isEmpty
                          ? Text(data!.propertyCity![0].name.toString(), style: primaryTextStyle(color: primaryColor), maxLines: 1)
                          : Text(userStore.cityName, style: primaryTextStyle(color: primaryColor), maxLines: 1, overflow: TextOverflow.ellipsis).expand()
                      : Text(language.selectCity, style: primaryTextStyle(color: primaryColor), maxLines: 1),
                ],
              ),
