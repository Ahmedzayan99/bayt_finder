...
class _PropertyContactHistoryScreenState extends State<PropertyContactHistoryScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: appBarWidget("contactInfoDetails", context1: context, titleSpace: 0),
        body: FutureBuilder(
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              if (categoryListModel.data![index].createdAt!.isNotEmpty)
                                Text("seenOn${parseDocumentDate(DateTime.parse(categoryListModel.data![index].createdAt.validate()))}", style: secondaryTextStyle())
                            ],
                          )
                        ]),
                      );
