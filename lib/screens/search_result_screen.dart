                    ...
                    children: [
                      ...
                      filterProperty.isNotEmpty
                          ? Column(
                              ...
                              children: [
                                10.height,
                                Text("${"found"} ${filterProperty.length} ${"estates"}",
                                        style: primaryTextStyle())
                                    .paddingSymmetric(horizontal: 16)
                                    .visible(
                                        appStore.mRecentSearchList.isNotEmpty),
                                20.height.visible(
                                    appStore.mRecentSearchList.isNotEmpty),
                                ListView.builder(
                          ...
                          : mPropertyData.isNotEmpty
                              ...
                              : Column(
                                      ...
                                      20.height,
                                      Text(
                                        "searchMsg".capitalizeFirstLetter() +
                                            title,
                                        style: secondaryTextStyle(),
                                        textAlign: TextAlign.center,
                                      ).paddingSymmetric(horizontal: 16)
                                    ])
                                  .visible(filterProperty.isEmpty &&
                                      mPropertyData.isEmpty &&
                                      !appStore.isLoading)
                                  .paddingSymmetric(
