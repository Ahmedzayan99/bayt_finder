...
class UpdateStataScreen extends StatelessWidget {
  const UpdateStataScreen({super.key});
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: () async {
                            await SharedPreferencesManager.saveData(
                                AppConstants.skipBoarding,  true);
                            navigateFinish( LayoutScreen());
                          },
                          child: Text(
                            'skip'.tr(),
                        ...
                        children: [
                          ...
                          MasterButton(
                            onPressed: () async {
                              if(registerCubit.intialStep==0){
                                await SharedPreferencesManager.saveData(
                                    AppConstants.interestType,  registerCubit.propertyForString);
                                registerCubit.selectStep();
                              }
                              else if(registerCubit.intialStep==1){
                                await SharedPreferencesManager.saveData(
                                    AppConstants.citySelectList,  registerCubit.citySelect);
                                registerCubit.selectStep();
                              }else if(registerCubit.intialStep==2){
                                registerCubit.updateUserStatus();
                                await SharedPreferencesManager.saveData(
                                    AppConstants.minBudget,  registerCubit.minController.text);
                                await SharedPreferencesManager.saveData(
                                    AppConstants.minBudget,  registerCubit.mixController.text);
                                await SharedPreferencesManager.saveData(
                                    AppConstants.skipBoarding,  true);
                              }
                            },
            ...
            child: InkWell(
                ...
                child: Container(
                  ...
                  child: Column(
                    spacing: 20.h,
                    children: [
                      Text(registerCubit.propertyList[0].title.toString().tr(),
            ...
            child: InkWell(
                ...
                child: Container(
                  ...
                  child: Column(
                    spacing: 20.h,
                    children: [
                      Text(registerCubit.propertyList[1].title.toString().tr(),
  ...
  Widget showSelectCity(
    ...
    return AuthTextFormField(
        hintText: "City, community or tower..".tr(),
        onTap: () {
          showModalBottomSheet(
            backgroundColor: AppColors.colorWhite,
            enableDrag: true,
                                      ...
                                      InkWell(
                                        onTap: () {
                                          registerCubit.selectCity(
                                            registerCubit
                                                .searchCityList[index].title,registerCubit
                                              .searchCityList[index].selectVal
                                          );
                                        },
                                        child: Icon(
          ...
          children: [
            ...
            SliderTheme(
              ...
              child: RangeSlider(
                ...
                min: registerCubit.configurationPriceModel.minPrice!.toDouble(),
